...
from frappe_sheets_next.sheets.doctype.sheet.storage import encode_sheets_data
from frappe_sheets_next.versioning import save as save_mod
...
class PayloadValidation(unittest.TestCase):
	...
	def test_non_string_throws(self):
		with mock.patch(
			"frappe_sheets_next.versioning.save.frappe.throw",
