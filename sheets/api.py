...
def ai_assist(name: str, prompt: str, selection: str) -> dict:
	...
	from sheets.ai import context as ai_context
	from sheets.ai import heuristics as ai_heuristics
	from sheets.ai import validate as ai_validate
	...
	if raw is None:
		if model.strip().lower() in ("mock", "demo"):
			...
			from sheets.ai import client as ai_client
